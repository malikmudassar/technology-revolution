...
var themeConfig = {
    ...
    initialize: function () {
        ...
        $('head').append($('<link rel="stylesheet">').attr('href', base_url+'template/front/js/theme-config.css'));
        $this.build();
        $this.events();
    ...
    setColor: function (color) {
        ...
        $colorConfigLink.attr('href', base_url+'template/front/css/theme-' + color + '.css');
        $.cookie('color', color);
    },
