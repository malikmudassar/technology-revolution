        ...
        ?>
                    	...
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" id="product_file">
                                ...
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('choose_file');?> (<?php echo translate('compressed');?> *.zip/*.rar)
                                    <input type="file" name="product_file" onchange="details(this);" id="demo-hor-12" class="form-control required"  accept='application/zip,application/rar'>
                                    </span>
                                    <br><br>
                                    <span>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('digital_add','<?php echo translate('product_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
