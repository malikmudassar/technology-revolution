                	...
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="set_slider" class='sw5' data-set='set_slider' type="checkbox" <?php if($this->crud_model->get_type_name_by_id('general_settings','53','value') == 'ok'){ ?>checked<?php } ?> />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo translate('top_carousel_slider');?></label>
                                <div class="col-sm-6">
                                    <input id="set_slides" class='sw5' data-set='set_slides' type="checkbox" <?php if($this->crud_model->get_type_name_by_id('general_settings','62','value') == 'ok'){ ?>checked<?php } ?> />
                                </div>
                            </div>
                            <?php
							...
							?>
                                <div class="form-group top_cat">
                                    ...
                                    <div class="col-sm-6">
                                        <?php 
											$categories =$this->db->get_where('ui_settings',array('ui_settings_id' => 35))->row()->value;
											echo $this->crud_model->select_html('category','top_category','category_name','edit','demo-cs-multiselect',$categories,'','','check_cat_length'); 
										?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-sm-12 top_cat_update"  style="margin-bottom:300px">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('category_menu_updated!'); ?>'>
                    	...
                    	<div class="col-md-12 form-horizontal">
                            ...
                            ?>
                                ...
                                <div class="form-group col-sm-12">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('search_section_updated!'); ?>'>
                                        <?php echo translate('update');?>
                                    </span>
                                </div>
                            </form>
                ...
                <div id="tabb-4" class="tab-pane fade">
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                        <div class="cc-selector col-sm-4">
                                            <input type="radio" id="box_<?php echo $value; ?>" value="<?php echo $value; ?>" name="fea_pro_box" <?php if($box_style == $value){ echo 'checked'; } ?> >
                                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; height:300px;" for="box_<?php echo $value; ?>">
            				...
            				<div class="form-group col-sm-12">
                            	<span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('featured_section_updated!'); ?>'>
									<?php echo translate('update');?>
                                </span>
                            </div>
            			</form>
                ...
                <div id="tabb-5" class="tab-pane fade">
                	<div class="row">
						...
						?>
            				...
            				<div class="form-group col-sm-12">
                            	<span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('vendor_section_updated!'); ?>'>
									<?php echo translate('update');?>
                                </span>
                            </div>
            			</form>
                    	...
                    	<div class="col-md-12 form-horizontal">
							...
							?>
                            	<div id="home_category_selection_box">
									...
									?>
                                    <div class="col-sm-8 col-sm-offset-2 element_box">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 category_select_div">
                                                <?php
													...
													foreach($category as $cat){
														$l++;
												?>
                                                	<div class="col-sm-3 radio_checker cat_<?php echo $cat['category_id']; ?>" onClick="get_cat('<?php echo $cat['category_id']; ?>',this)">
                                                    	<span class="cat_text">
                                        ...
                                        <div class="form-group sub">
                                            <label class="col-sm-3 control-label" for="demo-hor-3"><?php echo translate('sub-categories_(promotional)');?></label>				
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <div class="btn btn-mint btn-labeled fa fa-plus-square pull-right" onClick="add_home_cat_box()"></i> <?php echo translate('add_new');?></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        ?>
                                            <div class="cc-selector col-sm-4">
                                                ...
                                                <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; height:300px;" for="pbox_<?php echo $value; ?>">
                                                        <img src="<?php echo base_url() ?>uploads/product_boxes/<?php echo 'product_grid_'.$value.'.jpg' ?>" width="100%" height="100%" alt="<?php echo 'product_box_style_'.$value; ?>" />
                                ...
                                <div class="form-group col-sm-12">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('home_categories_updated!'); ?>'>
                                        <?php echo translate('update');?>
                                    </span>
                                </div>
                            </form>
                	...
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
							...
							?>
								...
								<div class="form-group col-sm-12">
									<span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('blog_section_updated!'); ?>'>
										<?php echo translate('update');?>
									</span>
								</div>
							</form>
                ...
                <div id="tabb-9" class="tab-pane fade">
                	<div class="row">
                    	<div class="col-md-12 form-horizontal">
            				...
            				<div class="form-group col-sm-12">
                            	<span class="btn btn-success btn-labeled fa fa-check submitter pull-right" type= data-ing='<?php echo translate('updating'); ?>' data-msg='<?php echo translate('brand_section_updated!'); ?>'>
									<?php echo translate('update');?>
                                </span>
                            </div>
            			</form>
...
function add_home_cat_box(){
	$('#home_category_selection_box').append(''
											...
											+'			<?php
															foreach($category as $cat){
														?>'
											+'				<div class="col-sm-4 radio_checker cat_<?php echo $cat['category_id']; ?>" onClick="get_cat('+"'"+<?php echo $cat['category_id']; ?>+"'"+',this)">'
											+'					<?php echo $cat['category_name']; ?>'
											+'					<input type="checkbox" style="display:none;" class="radio_pat"'
