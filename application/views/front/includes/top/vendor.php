        ...
        <!-- for summernote -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>template/front/summernote/summernote.css"
        <!-- for dataTables -->
        <link href="<?php echo base_url(); ?>template/front/plugins/bootstrap/css/dataTables.bootstrap.min.css" rel="stylesheet">
