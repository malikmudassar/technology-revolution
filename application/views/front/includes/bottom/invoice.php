        ...
        <script src="<?php echo base_url(); ?>template/front/plugins/countdown/jquery.countdown.min.js"></script>					        <script src="<?php echo base_url(); ?>template/front/plugins/owl-carousel2/owl.carousel.min.js"></script>
