    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <form action="#" class="form-login">
            <div class="row product-form">
                <div class="information-title"><?php echo translate('create_coupon');?></div>
                <div class="col-md-12 col-sm-12 col-xs-12 input">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input type="text" class="form-control" placeholder="<?php echo translate('title:');?>">
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 input">
                    <label class="col-md-3 col-sm-3 col-xs-3"><?php echo translate('valid_till:');?></label>
                    <div class="col-md-9 col-sm-9 col-xs-9">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 input">
                    <label class="col-md-3 col-sm-3 col-xs-3">
                        <?php echo translate('coupon_code:');?>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input type="text" class="form-control" placeholder="<?php echo translate('title:');?>">
                    </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 input">
                    <label class="col-md-3 col-sm-3 col-xs-3">
                        <?php echo translate('discount_type:');?>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <select class="form-control">
                            <option disabled selected><?php echo translate('select...');?></option>
                            <option value=""><?php echo translate('percent');?></option>
                            <option value=""><?php echo translate('amount');?></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 input">
                    <label class="col-md-3 col-sm-3 col-xs-3">
                        <?php echo translate('discount_value:');?>
                    </label>
                    <div class="col-md-9 col-sm-9 col-xs-9">
