                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="information-title margin-bottom-0">
                                    	<?php echo translate('fill_the_form_to_Create_Product');?>
                                    </div>
                                    <div class="col-md-12 product-form" id="sel">
                                        <label class="col-md-3 col-sm-3 col-xs-3">
                                        	<?php echo translate('select_product_type:');?></label>
                                    ...
                                    <form action="#" class="form-login">
                                        <div class="col-md-12" id="digital" style="display:none;">
                                            <div class="tabs-wrapper content-tabs">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#tab1" data-toggle="tab">
                                                    	<?php echo translate('product_details');?></a></li>
                                                    <li><a href="#tab2" data-toggle="tab">
                                                    	<?php echo translate('business_details');?></a></li>
                                                    <li><a href="#tab3" data-toggle="tab">
                                                    	<?php echo translate('customer_choice_options');?></a></li>
                                                </ul>
                                                    ...
                                                    <div class="tab-pane fade in active" id="tab1">
                                                        <div class="row product-form">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">
                                                                	<?php echo translate('product_title:');?></label>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">
                                                                	<?php echo translate('categoty:');?></label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                    ...
                                                    <div class="tab-pane fade" id="tab2">
                                                        <div class="row product-form">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Purchase Price">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                                    $ /
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Product Tax">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                                    <select class="form-control">
                                    ...
                                    <form action="#" class="form-login">
                                        <div class="col-md-12" id="others" style="display:none;">
                                            <div class="tabs-wrapper content-tabs">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#tab4" data-toggle="tab">Product Details</a></li>
                                                    <li><a href="#tab5" data-toggle="tab">Business Details</a></li>
                                                    <li><a href="#tab6" data-toggle="tab">Customer Choice Options</a></li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="tab4">
                                                        <div class="row product-form">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Product Title:</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <input class="form-control" type="text" placeholder="Product Title">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Categoty:</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <select class="form-control">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Unit:</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <input class="form-control" type="text" placeholder="Unit">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Tags:</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <input class="form-control" data-role="tagsinput" type="text" placeholder="Tags">
                                                                </div>
                                                            </div>
                                                            <div class="multi_image">
                                                                <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Description:</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9" style="margin-bottom:20px;">
                                                                    <textarea name="text" class="summernote" id="contents" title="Contents"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <button class="btn btn_cus btn-theme-sm btn-theme-dark pull-right" href="#">Next</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="tab5">
                                                        <div class="row product-form">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Sale Price:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Purchase Price:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Purchase Price">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Shipping Cost:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Shipping Cost">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                                    $ /
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Product Tax:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Product Tax">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Product Discount:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="text" placeholder="Product Discount">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-3">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <button class="btn btn_cus btn-theme-sm btn-theme-dark pull-right" href="#">Next</button>
                                                                <button class="btn btn_cus btn-theme-sm btn-theme-dark pull-right" href="#">Previous</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="tab6">
                                                        <div class="row product-form">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <label class="col-md-3 col-sm-3 col-xs-3">Color:</label>
                                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                                    <input class="form-control" type="color" name="color[t_0]">
                                                                </div>
                                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                                    <button type="button" class="btn btn-theme-sm  btn-more pull-right add_more_color"><i class="glyphicon glyphicon-plus"></i> Add More Color</button>
                                                                </div>
                                                            </div>
                                                            <div class="more_color">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-9 col-md-offset-3 col-sm-offset-3 col-xs-offset-3">
                                                                <h5>If You Need More Choice Options For Customers Of This Product ,please Click Here.</h5>
                                                            </div>
                                                            <div class="more_field">
                                                
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-xs-12 input">
                                                                <button type="button" class="btn btn_cus btn-theme-sm btn-more pull-right add_more_field"><i class="glyphicon glyphicon-plus"></i> Add Customer Input Options</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div id="imageInp_dummy" style="display:none;">
                            <div class="rem">
                                <div class="col-md-12 col-sm-12 col-xs-12 input">
                                    <label class="col-md-3 col-sm-3 col-xs-3">
                                    	<?php echo translate('image:')?></label>
                                    <div class="col-md-9 col-sm-9 col-xs-9 file">
                                        <div class="col-md-12 col-sm-12 col-xs-12 col-xs-12">
                                            <img class="img-responsive img-box blah"  src="<?php echo base_url(); ?>uploads/others/photo_default.png"  >
                                        </div>
                        ...
                        <div id="field_dummy" style="display:none;">
                            <div class="rem">
                                <div class="col-md-12 col-sm-12 col-xs-12 input">
                                    <div class="col-md-3 col-sm-3 col-xs-3">
                                        <input class="form-control" type="text" name="nm[{{i}}]" placeholder="<?php echo translate('name');?>">
                                    </div>
                                    <div class="col-md-8 col-sm-8 col-xs-8">
                                        <input class="form-control" type="text" name="desc[{{i}}]" placeholder="<?php echo translate('description');?>">
                                    </div>
...
<script>
	...
	$(document).ready(function() {
		set_summernote();
		$(".content-area").on('change',"#product_type", function(){
