...
<div class="main-slider">
    ...
    <div class="item slide1 active alt">
		...
		<?php if(file_exists('uploads/vendor/banner_'.$vendor_id.'.jpg')){?>
            <img class="slide-img"  src="<?php echo base_url();?>uploads/vendor/banner_<?php echo $vendor_id;?>.jpg"/>
        <?php }else{?>
            <img class="slide-img"  src="<?php echo base_url();?>uploads/others/photo_default.png"/>	
        <?php }?>
    </div>
    <?php
    $i=2;
