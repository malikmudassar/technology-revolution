                                ...
                                <div class="img-bg" id="blah"  
                                    style="background-size: cover; background-image: url('<?php 
                                        if(file_exists('uploads/user_image/user_'.$row['user_id'].'.jpg')){ 
                                            ...
                                            echo base_url(). "uploads/user_image/default.png";
                                        } ?>')">
                                </div>
                            </a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="thumbnail no-border no-padding thumbnail-banner size-1x3" style="height:auto;">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url('<?php echo base_url(); ?>template/front/img/preview/shop/banner-1.jpg')"></div>
                            <div class="caption">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        ...
                                        <span class="btn btn-theme btn-theme-sm order_history">My Orders</span>
                                    </div>
                                </div>
                            </div>
                        </a>
            ...
            <div class="col-md-6">
                <div class="thumbnail no-border no-padding thumbnail-banner size-1x3" style="height:auto;">
                    <div class="media">
                        <a class="media-link" href="#">
                            <div class="img-bg" style="background-image: url('<?php echo base_url(); ?>template/front/img/preview/shop/banner-2.jpg')"></div>
                            <div class="caption text-right">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        ...
                                        <span class="btn btn-theme btn-theme-sm wishlist_view">Wishlist</span>
                                    </div>
                                </div>
                            </div>
                        </a>
