<div class="thumbnail box-style-3 no-border no-padding">
    <div class="media">
    	<div class="cover"></div>
        <div class="media-link" style="background-image:url('<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>'); height:300px;background-size:cover;">
    ...
    <div class="caption text-center">
        ...
        <div class="buttons">
            <span class="btn  btn-theme-transparent btn-wish-list" onclick="to_wishlist(<?php echo $product_id; ?>)"
            ...
            <span class="btn  btn-theme-transparent btn-icon-left" onclick="to_cart(<?php echo $product_id; ?>)">
            ...
            <span class="btn  btn-theme-transparent btn-compare" onclick="do_compare(<?php echo $product_id; ?>)"
