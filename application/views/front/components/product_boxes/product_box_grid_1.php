<div class="thumbnail box-style-1 no-padding">
    <div class="media">
    	<div class="cover"></div>
        <div class="media-link" style="background-image:url('<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>');background-size:cover;">
        	<?php
    ...
    <div class="caption text-center">
        ...
        <div class="button">
            <span class="icon-view left" onclick="do_compare(<?php echo $product_id; ?>)" data-toggle="tooltip" 
            ...
            <span class="icon-view middle" onclick="to_wishlist(<?php echo $product_id; ?>)" data-toggle="tooltip" 
            ...
            <span class="icon-view right " onclick="to_cart(<?php echo $product_id; ?>)" data-toggle="tooltip" 
