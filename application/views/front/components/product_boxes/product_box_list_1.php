<div class="thumbnail list_box_style1">
    <div class="row product-single">
        <div class="col-md-4">
            <div class="media">
            	<div class="cover"></div>
                <div class="media-link" style="background-image:url('<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>'); height:230px; background-size:cover; background-position:center;">
