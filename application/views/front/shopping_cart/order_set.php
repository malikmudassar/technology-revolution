                ...
                <td class="quantity product-single" style="text-align:center;">
                    ...
                    <span class="buttons">
                        <div class="quantity product-quantity">
                            <button type='button' class="btn quantity-button minus"  value='minus' >
                                <i class="fa fa-minus"></i>
                            </button>
                            <input  type="number" class="form-control qty quantity-field quantity_field" data-rowid="<?php echo $items['rowid']; ?>" data-limit='no' value="<?php echo $items['qty']; ?>" id='qty1' onblur="check_ok(this);" />
                            <button type='button' class="btn quantity-button plus"  value='plus' >
                                <i class="fa fa-plus"></i>
                            </button>
                        </div>
                    </span>
...
<div class="col-md-4">
    ...
    <div class="shopping-cart">
        <table>
            <tr>
                <td><?php echo translate('sub-total:');?></td>
                <td  id="total"></td>
            </tr>
            <tr>
