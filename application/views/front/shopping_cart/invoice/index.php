<section class="page-section invoice">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="invoice_body">
                    <div class="invoice-title">
                        <div class="invoice_logo">
                            <img class="img-responsive" src="<?php echo base_url(); ?>template/front/img/logo-supershop.png" alt="SuperShop"/>
                        </div>
                        <div class="invoice_info">
                            <p><b><?php echo translate('invoice_#_:'); ?></b><?php echo $row['sale_code']; ?></p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <address>
								...
								?>
                                <p>
                                    <b><?php echo translate('first_name_:'); ?></b>
                                    <?php echo $info['firstname']; ?>
                                </p>
                                <p>
                                    <b><?php echo translate('last_name_:'); ?></b>
                                    <?php echo $info['lastname']; ?>
                                </p>
                                <p>
                                    <b><?php echo translate('address_:'); ?></b>
                                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 ">
                            <address>
                                <strong>
                                    <h4>
                                        <?php echo translate('payment_details_:'); ?>
                                    </h4>
                                </strong>
                                <p>
                                    <b><?php echo translate('payment_status_:'); ?></b>
                                    <i><?php echo translate($this->crud_model->sale_payment_status($row['sale_id'])); ?></i>
                                </p>
                                <p>
                                    <b><?php echo translate('payment_method_:'); ?></b>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6  text-right">
                            <address>
                                <strong>
                                    <h4>
                                        <?php echo translate('order_date_:'); ?>
                                    </h4>
                                    <p>
            ...
            <div class="col-md-10 col-md-offset-1 btn_print" style="margin-top:10px;">
