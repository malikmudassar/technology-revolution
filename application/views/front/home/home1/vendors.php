<!-- PAGE -->
<section class="page-section image testimonials vendors" style="background: url(<?php echo base_url(); ?>uploads/others/parralax_vendor.jpg) center top no-repeat; background-attachment:fixed; background-size:cover;">
    <div class="container">
