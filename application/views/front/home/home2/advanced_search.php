        ...
        <div class="container">
            ...
            ?>
                                ...
                                data-min="<?php echo round($this->crud_model->get_range_lvl('product_id !=', '0', "min")); ?>" 
                                   data-max="<?php echo round($this->crud_model->get_range_lvl('product_id !=', '0', "max")); ?>" 
                                    data-brands="<?php echo join('-',$this->crud_model->get_brands('category','0')); ?>" 
                                        data-subdets='<?php echo $this->crud_model->sub_details_by_cat('0'); ?>'>
                                ...
                                data-cat="<?php echo $row1['category_id']; ?>" 
                                    data-min="<?php echo round($this->crud_model->get_range_lvl('category', $row1['category_id'], "min")); ?>" 
                                       data-max="<?php echo round($this->crud_model->get_range_lvl('category', $row1['category_id'], "max")); ?>" 
                                        data-brands="<?php echo join('-',$this->crud_model->get_brands('category',$row1['category_id'])); ?>" 
                                            data-subdets='<?php echo $this->crud_model->sub_details_by_cat($row1['category_id']); ?>'>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                    <input class="form-control" type="text" name="query" placeholder="What Are You Looking?">
                    </div>
                    <div class="col-md-4">
