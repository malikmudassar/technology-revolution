            ...
            <ul class="list-inline">
                <li class="dropdown flags">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        ?>
                        <img src="<?php echo $this->crud_model->file_view('language_list',$lid,'','','no','src','','','.jpg') ?>" width="20px;" alt=""/> <?php echo $lnm; ?> <i class="fa fa-angle-down"></i></a>
                ...
                <li class="dropdown flags" style="z-index: 1001;">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        ?>
                        <?php echo $c_name; ?> (<?php echo $symbol; ?>)
        ...
        <div class="container">
            ...
            <div class="header-cart">
                <div class="cart-wrapper">
                    <a href="<?php echo base_url(); ?>index.php/home/compare" class="btn btn-theme-transparent hidden-xs hidden-sm" id="compare_tooltip" data-toggle="tooltip" data-original-title="<?php echo $this->crud_model->compared_num(); ?>" data-placement="right" >
        ...
        <div class="container">
            ...
            <nav class="navigation closed clearfix">
                ...
                <ul class="nav sf-menu">
                    ...
                    <li <?php if($asset_page=='all_category'){ ?>class="active"<?php } ?>>
					...
					?>
                    <li <?php if($asset_page=='blog'){ ?>class="active"<?php } ?>>
